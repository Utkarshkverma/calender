...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> globalExceptionHandler(ResourceNotFoundException e, WebRequest webRequest) {
        String apiPath = extractApiPath(webRequest.getDescription(false));
        ErrorResponseDto errorResponseDto = new ErrorResponseDto(
                apiPath,
    ...
    public ResponseEntity<ErrorResponseDto> globalExceptionHandler(ResponseException e, WebRequest webRequest) {
        String apiPath = extractApiPath(webRequest.getDescription(false));
        ErrorResponseDto errorResponseDto = new ErrorResponseDto(
                apiPath,
                HttpStatus.CONFLICT,
